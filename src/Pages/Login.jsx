...
import { redirectToOAuthAuthorize } from "../utils/oauth";
...
export default function Login() {
  ...
  const handleGoogleLogin = () => {
    redirectToOAuthAuthorize("google");
  };
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <div className="flex items-center justify-between">
                ...
                <Link
                  to="/forgot-password"
                  className="text-sm border-none bg-transparent m-0 p-0 text-indigo-600 hover:text-indigo-500 font-medium cursor-pointer transition-colors"
                >
                  Forgot password?
                </Link>
              </div>
